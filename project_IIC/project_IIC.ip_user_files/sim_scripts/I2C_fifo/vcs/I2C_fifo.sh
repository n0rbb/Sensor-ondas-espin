...
#                script (type 'I2C_fifo.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.I2C_fifo xil_defaultlib.glbl -o I2C_fifo_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./I2C_fifo_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key I2C_fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc I2C_fifo_simv.daidir vcs_lib c.obj)
