...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.I2C_fifo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.I2C_fifo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log I2C_fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
