...
HD_PWD='C:/Users/worbb/Desktop/IMA/Sensor-ondas-espin/2025-Heterodyne-Spartan7/SW_Sensor/SW_Sensor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Spartan_SWS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Spartan_SWS.tcl -notrace
