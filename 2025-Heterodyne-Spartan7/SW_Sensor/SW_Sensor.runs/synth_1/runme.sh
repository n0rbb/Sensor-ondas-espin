...
HD_PWD='C:/Users/worbb/Desktop/IMA/Sensor-ondas-espin/2025-Heterodyne-Spartan7/SW_Sensor/SW_Sensor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Spartan_SWS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Spartan_SWS.tcl
