...
HD_PWD='C:/Users/worbb/Desktop/IMA/FPGA/SW_Sensor/SW_Sensor.runs/RS232_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RS232_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RS232_fifo.tcl
