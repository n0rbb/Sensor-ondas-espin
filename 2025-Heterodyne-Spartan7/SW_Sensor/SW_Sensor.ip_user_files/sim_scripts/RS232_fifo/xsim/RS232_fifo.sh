...
#
# Script generated by Vivado on Wed Jun 25 11:38:43 +0200 2025
...
# script info
echo -e "RS232_fifo.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RS232_fifo xil_defaultlib.RS232_fifo xil_defaultlib.glbl -log elaborate.log
}
