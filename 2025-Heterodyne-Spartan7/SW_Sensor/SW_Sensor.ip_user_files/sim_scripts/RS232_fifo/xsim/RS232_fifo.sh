...
#
# Script generated by Vivado on Mon Apr 21 18:03:52 +0200 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : RS232_fifo.sh
...
#
# Usage        : RS232_fifo.sh
#                RS232_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                RS232_fifo.sh [-reset_run]
#                RS232_fifo.sh [-reset_log]
#                RS232_fifo.sh [-help]
#
...
# script info
echo -e "RS232_fifo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./RS232_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot RS232_fifo xil_defaultlib.RS232_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim RS232_fifo -key {Behavioral:sim_1:Functional:RS232_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb RS232_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./RS232_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: RS232_fifo.sh [-help]\n\
Usage: RS232_fifo.sh [-step]\n\
Usage: RS232_fifo.sh [-lib_map_path]\n\
Usage: RS232_fifo.sh [-reset_run]\n\
Usage: RS232_fifo.sh [-reset_log]\n\
Usage: RS232_fifo.sh [-keep_index]\n\
Usage: RS232_fifo.sh [-noclean_files]\n\n\
