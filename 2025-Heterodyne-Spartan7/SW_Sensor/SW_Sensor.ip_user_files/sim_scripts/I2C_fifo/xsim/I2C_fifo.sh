...
#
# Script generated by Vivado on Mon May 05 11:40:41 +0200 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : I2C_fifo.sh
...
#
# Usage        : I2C_fifo.sh
#                I2C_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                I2C_fifo.sh [-reset_run]
#                I2C_fifo.sh [-reset_log]
#                I2C_fifo.sh [-help]
#
...
# script info
echo -e "I2C_fifo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./I2C_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_10 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot I2C_fifo xil_defaultlib.I2C_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim I2C_fifo -key {Behavioral:sim_1:Functional:I2C_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb I2C_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./I2C_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: I2C_fifo.sh [-help]\n\
Usage: I2C_fifo.sh [-step]\n\
Usage: I2C_fifo.sh [-lib_map_path]\n\
Usage: I2C_fifo.sh [-reset_run]\n\
Usage: I2C_fifo.sh [-reset_log]\n\
Usage: I2C_fifo.sh [-keep_index]\n\
Usage: I2C_fifo.sh [-noclean_files]\n\n\
